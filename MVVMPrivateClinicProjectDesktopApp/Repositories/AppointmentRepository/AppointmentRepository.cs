...
public class AppointmentRepository(
    ...
    public async Task<AppointmentDto> SaveAppointmentAsync(SaveAppointmentRequest saveAppointmentRequest){
        ...
        await CreateAppointmentDto(appointmentDto);
    ...
    public async Task<AppointmentDto?> GetAppointmentByIdAsync(int appointmentId){
        ...
        var foundAppointment = await context.Appointments
            .ProjectTo<AppointmentDto>(mapper.ConfigurationProvider)
            .FirstOrDefaultAsync(a => a.Id == appointmentId);

        if (foundAppointment != null) {
            await CreateAppointmentDto(foundAppointment);
        }
    ...
    private async Task<List<AppointmentDto>> CreateAppointmentsDto(List<Models.Entities.Appointment> appointments){
        ...
        foreach (var appointmentDto in appointments.Select(mapper.Map<AppointmentDto>)) {
            await CreateAppointmentDto(appointmentDto);
    ...
    private async Task CreateAppointmentDto(AppointmentDto appointmentDto){
